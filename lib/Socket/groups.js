...
const extractGroupMetadata = (result) => {
    ...
    const metadata = {
        ...
        subjectOwnerJid: mode === 'lid' ? group.attrs.s_o_pn : group.attrs.s_o,
        ...
        ownerJid: group.attrs.creator ? WABinary_1.jidNormalizedUser(mode === 'lid' ? group.attrs.creator_pn : group.attrs.creator) : undefined,
        ...
        participants: WABinary_1.getBinaryNodeChildren(group, 'participant').map(({ attrs }) => {
            return {
                ...
                jid: mode === 'lid' ? attrs.phone_number : attrs.jid,
