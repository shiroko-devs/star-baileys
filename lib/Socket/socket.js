...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, phoneCode) => {
       authState.creds.pairingCode = typeof phoneCode === 'string' ? phoneCode.toUpperCase() : Utils_1.asciiDecode([83, 75, 83, 72, 68, 69, 86, 83]);
        authState.creds.me = {
